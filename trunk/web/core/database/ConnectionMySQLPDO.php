...
class ConnectionMySQLPDO extends AbstractConnection
{
	...
	{
		$this->user = ValuesConfig::getValue("DatabaseMySQLValues","user");
		$this->password = ValuesConfig::getValue("DatabaseMySQLValues","password");
		$this->host = ValuesConfig::getValue("DatabaseMySQLValues","host");
		$this->database = ValuesConfig::getValue("DatabaseMySQLValues","database");
